...
function getGenreDescription(genre: string): string {
  const descriptions: Record<string, string> = {
    ...
    humor: 'Hilarious stories that will make you laugh out loud',
    'cooking': 'Delicious adventures in the magical world of food',
    'pets': 'Wonderful tales with furry and feathered friends',
    'historical': 'Amazing journeys through time and history',
    'comedy': 'Fun stories filled with jokes and laughter',
    'tech-tales': 'Exciting adventures in the world of technology',
