...
export const genresByAge = {
  ...
  teen: [
    ...
    { value: "romance", label: "Young Romance" },
...
export const moralsByAge = {
  ...
  adult: [
    { value: "ethical-choices", label: "Ethical Choices" },
    { value: "cultural-understanding", label: "Cultural Understanding" },
    { value: "mortality", label: "Mortality & Legacy" },
    ...
    { value: "existential", label: "Existential Questions" },
  ],
};